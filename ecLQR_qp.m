function Soln = ecLQR_qp(param, xN,  A_list, B_list, C_list, D_list, G_list, r_list, h_list)
...
bigA = sparse(N*(nx+ncxu+ncx) + nx, N*(nx+nu)+nx); % extra equation for x0
bigB = sparse(N*(nx+ncxu+ncx) + nx, 1);
